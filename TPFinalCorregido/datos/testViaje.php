...
function agregarPasajero($idViaje){
    ...
    $pasajeroNuevo->cargar(0,$docPas,$nombrePas,$apellidoPas,$telefonoPas,0,$idViaje);
            ...
            do {
                ...
                switch($opMenuAgregar){
                    ...
                    case 3:    //agrega responsables
                        ...
                        if (!$auxPersona->Buscar2($docRV)){
                            echo "Ingrese el numero de licencia: " ; 
                            $nroLicecia = trim(fgets(STDIN));
                            $responsableNuevo = new ResponsableV();
                            
                            $responsableNuevo->cargar(0,$docRV,$nombreRV,$apellidoRV,$telefonoRV,0,$nroLicecia);
                            ...
                            //echo $viajeModi;
                                    ...
                                    switch($opModificarViaje){
                                        ...
                                        case 3: //importe
                                            ...
                                            break;
                                        case 4:  //un pasajero 
                                            echo "Conoce el ID del pasajero a modificar?: ";
            ...
            do {
                ...
                switch($opMenuEliminar){
                    case 1: //elimina empresa 
                        ...
                        if ($empresa!=null){
                            ...
                            if ($empresa->Buscar($idEmpEliminar)){
                                echo "*****************************************\n";
                                echo "***  Esta por Eliminar los Datos de  ***\n";
                                echo "***  Empresa " . $empresa->getIdEmpresa() . " ". $empresa->getNombre() . "  ***\n";
                                echo "*****************************************\n";
                            ...
                            switch($opEliminarViaje){
                                case 1: //elimina a un pasajero
                                    ...
                                    if ($objViajeEP!=null){
                                        ...
                                        if ($objViajeEP->Buscar($idViajePEl)){
                                            echo "Conoce el ID del pasajero a eliminar? (si/no): ";
                                ...
                                case 2:  //elimina a todo el viaje
                                    ...
                                    if ($viaje!=null){
                                        ...
                                        if ($viaje->Buscar($id)){
                                            echo "*****************************************\n";
                                            echo "***  Esta por Eliminar los Datos del  ***\n";
                                            echo "***   Viaje " . $viaje->getIdViaje() . " con destino a ". $viaje->getDestino() . "  ***\n";
                                            echo "*****************************************\n";
                                            $auxPasajero = new Pasajero();
                    ...
                    case 3:  //elimina responsables 
                        echo "Conoce el ID del responsable a eliminar?(si/no): ";
                        $opSN = trim(fgets(STDIN));
